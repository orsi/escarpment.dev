  ...
  return (
    <>
      ...
      <section className="bg-white px-6 py-16 sm:px-8 lg:px-10">
        <div className="max-w-7xl mx-auto overflow-auto md:overflow-visible flex gap-8">
          <motion.div
            className="flex-1 w-1/3 min-w-40 bg-primary-main border border-primary-light rounded text-white/95"
            initial={{
              opacity: 0,
      ...
      <section>
        <div className="h-32 bg-[linear-gradient(2deg,var(--color-secondary-light)_100px,white_10px)]" />
        <div className="px-6 sm:px-8 lg:px-10 bg-secondary-light">
        ...
        <div className="md:block h-16 md:h-32 bg-secondary-light md:bg-[linear-gradient(2deg,var(--color-gray-100)_100px,var(--color-secondary-light)_10px)]" />
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="md:grid md:grid-cols-2 md:gap-8 md:items-center">
            ...
            <div className="px-6 lg:px-0 py-16 md:py-0">
              ...
              <Link
                className="mt-4 inline-flex items-center rounded-3xl py-2 px-6 bg-primary-main text-white font-bold transition-transform duration-200 hover:-translate-y-0.5"
                href="/contact"
              >
                Contact us now
              </Link>
